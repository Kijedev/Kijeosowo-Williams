...
const ProjectWalkthrough = () => {
  ...
  const project = useMemo(
    () => projects?.mobile?.find((item) => item.slug === id)?.walkthrough
  );
        ...
        >
          ...
          <div className="bg-[#112240] p-4 rounded-lg shadow-xl">
            ...
            <p className="mt-4 text-sm text-[#64FFDA] text-center">
              Full demo (3:26) -{" "}
              <a href="#" className="hover:text-[#52e3c7]">
                View transcript
              </a>
            </p>
          </div>
                  ...
                  <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2">
                    {section.content?.features?.map((feature, index) => (
                      ...
                      >
                        ...
                        {/* Components */}
                        <div className="mb-6">
                          <h4 className="text-[#64FFDA] text-sm font-mono mb-3">
                            MAIN COMPONENTS
                          </h4>
                          <ul className="space-y-2">
                            {feature.components.map((component, i) => (
                              <li key={i} className="flex items-start text-sm">
                                <span className="text-[#64FFDA] mr-2 mt-1">
                                  ▹
                                </span>
                                {component}
                              </li>
