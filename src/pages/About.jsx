        ...
        <>
          ...
          <div className="mt-10">
            <motion.h1
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="text-white mx-5 lg:ml-20 text-5xl pt-5 font-light"
            >
              Work History
            </motion.h1>
            ...
            {[
              {
                title: "AiTeacha (Lagos, Nigeria ) - Oct 2025 - Nov 2025",
              ...
              {
                title: "Postivus (Lagos, Nigeria) - Feb 2025",
              ...
              {
                title: "Taoltech (Lagos, Nigeria) - Aug 2023 - Dec 2024",
              ...
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true, amount: 0.2 }}
                className="lg:my-10 my-10 lg:mx-20 mx-5 border-t border-stone-700 py-5"
              >
                <h1 className="lg:text-3xl text-2xl font-[300] hover:text-stone-500 transition duration-300">
                  {job.title}
                </h1>
                <p className="dark:text-neutral-500 py-3">{job.role}</p>
                <p className="dark:text-neutral-500 py-3 bg-white/5 p-5 rounded">
                  {job.desc}
                </p>
              </motion.div>
